...
from nsga2.crowdingDistance import crowdingDistance
from nsga2.sortingnsga2 import sortingNSGA2
...
mProblem = 'kursawe' # 'test' # 'kursawe' # 'test'
...
mMaxIt = 100# mParams.n_max_itrations # Maximum Number of Iterations
mPop = 50# mParams.n_max_population # Population Size
...
mPopulation, mF = nonDominatedSorting(mPopulation, mOptimization)

#%% CrowdingDistance
mPopulation  = crowdingDistance(mPopulation, mF)
 
#%% SOrting
mPopulation, mF = sortingNSGA2(mPopulation)
...
for itr in range(mMaxIt):
    ...
    #% Non Dominated Sorting 
    mPopulation, mF = nonDominatedSorting(itrPopulation, mOptimization)
    del itrPopulation
    ...
    # Remove worst ones
    mPopulation = [mPopulation[i] for i in range(mPop)]
    mF = []
    ## Re genrate sorting
    mPopulation, mF = nonDominatedSorting(mPopulation, mOptimization)
    #% CrowdingDistance
